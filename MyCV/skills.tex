...
\item \ifnativelang Expérience en normes logicielles \& médicales\fi
\end{itemize}
}{\textbf{\small{\ifnativelang Recherche\else Project steering\fi}}}{
\begin{itemize}
\item 10+ articles scientifiques, 1 best-paper
%\item \ifnativelang Exp\'erience marquage CE \& certif. FDA\else Documentation and regulatory affairs \fi
%\item CE Mark (ISO 62304) \& FDA clearance %(21CFR11/820)
