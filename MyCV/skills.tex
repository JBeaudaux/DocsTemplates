...
\begin{itemize}
\item \ifnativelang OSs temps-r\'eel \else Real-time OSs \fi : Keil CMSIS, Contiki, QNX %ThreadX
\item \ifnativelang Linux embarqu\'e \else Embedded Linux \fi : Buildroot, Yocto
\item \ifnativelang Communication SPI, UART, I2C, CAN \else Networking\fi
