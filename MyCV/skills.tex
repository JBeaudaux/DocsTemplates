...
\begin{itemize}
\item \ifnativelang OSs temps-r\'eel \else Real-time OSs \fi : Free-RTOS, RTX, Contiki
...
\begin{itemize}
\item \ifnativelang Connaissances en gestion de projet \else Knowledge in progect management\fi
...
\item \ifnativelang Normes médicales \else Medical norms \fi : ISO 62304, CE \& FDA
